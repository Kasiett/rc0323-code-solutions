...
const { title: titleVar, author: authorVar, libraryID: libraryIDVar } = book2;
console.log(
  `The title of the book is ${titleVar},  the author is ${authorVar}, and the library ID is ${libraryIDVar}`
);
